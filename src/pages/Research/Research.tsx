    ...
    <>
      ...
      <div className="research-container">
        ...
        <div className="research-direction-card">
          ...
          <div className="funding-badge">Funded by ANR-3IA (ANR-19-PI3A-0004) and the NSF AI Research Institute on Interaction for AI Assistants (ARIA; NSF Cooperative Agreement No. 2433429)</div>
        </div>
