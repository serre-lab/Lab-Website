      ...
      <div className="titleDesc-container">
        ...
        <div className="research-direction-card">
          ...
          <Text className="research-direction-text">
            We are developing methods to quantify and improve the alignment between deep neural networks and human visual processing. Our <Anchor href="https://arxiv.org/abs/2504.16940" target="_blank" className="research-link">recent work</Anchor> reveals that despite impressive performance, current vision models process information fundamentally differently from humans—a gap crucial to understanding both for building more robust AI systems and for revealing brain mechanisms that support human vision. Our harmonization procedure demonstrates that alignment can be dramatically improved without changing network architectures, suggesting the misalignment stems not from structural limitations but from how these models are trained. This insight has led us to adopt a <Anchor href="https://openreview.net/forum?id=KeiQNpb7sv" target="_blank" className="research-link">developmental psychology approach</Anchor>, identifying the learning principles and developmental trajectories that shape human vision—principles we can incorporate into AI training to create models that not only perform well but genuinely see the world as humans do.
          </Text>
          <div className="funding-badge">Funded by NSF (IIS-2402875)</div>
        </div>
        
        <div className="research-direction-card">
          <Title order={3} className="research-direction-title">Cognitive Benchmarks for AI Visual Reasoning</Title>
          <Text className="research-direction-text">
            We develop rigorous cognitive-psychology-inspired tests to evaluate fundamental gaps between human and machine vision. Our benchmarks reveal systematic failures in modern AI: the <Anchor href="https://proceedings.neurips.cc/paper/2018/hash/ec8956637a99787bd197eacd77acce5e-Abstract.html" target="_blank" className="research-link">Pathfinder challenge</Anchor> shows feedforward networks fail at contour integration that humans solve effortlessly—a test later adopted by Google DeepMind, who confirmed that even state-of-the-art transformers fail while our brain-inspired recurrent models succeed. Our <Anchor href="https://proceedings.neurips.cc/paper_files/paper/2022/hash/c08ee8fe3d19521f3bfa4102898329fd-Abstract-Datasets_and_Benchmarks.html" target="_blank" className="research-link">compositional reasoning benchmark</Anchor> reveals AI's inability to flexibly combine visual concepts, while the <Anchor href="https://openreview.net/forum?id=UIFAJZ22ZF" target="_blank" className="research-link">3D-PC benchmark</Anchor> demonstrates failure at visual perspective-taking—a key signature of theory of mind. Even seemingly simple same-different judgments expose how neural networks struggle with basic visual relationships—work that also helps identify brain mechanisms underlying relational processing.
          </Text>
        ...
        <div className="research-direction-card">
          ...
          <Text className="research-direction-text">
            In collaboration with the Artificial and Natural Intelligence Toulouse Institute, we're creating tools to understand and interpret deep learning models. Our <Anchor href="https://openaccess.thecvf.com/content/CVPR2023/papers/Fel_CRAFT_Concept_Recursive_Activation_FacTorization_for_Explainability_CVPR_2023_paper.pdf" target="_blank" className="research-link">CRAFT framework</Anchor> (Fel et al., CVPR 2023) and <Anchor href="https://proceedings.neurips.cc/paper_files/paper/2023/hash/76d2f8e328e1081c22a77ca0fa330ca5-Abstract-Conference.html" target="_blank" className="research-link">MACO approach</Anchor> (Fel et al., NeurIPS 2023) help researchers peek inside the "black box" of AI. CRAFT provides concept-based explanations that reveal both "what" and "where" models look, while MACO unlocks feature visualization for state-of-the-art deep networks. These methods are implemented in our open-source <Anchor href="https://github.com/deel-ai/xplique" target="_blank" className="research-link">Xplique toolbox</Anchor>, making explainability accessible to the broader research community. Critically, our explainability tools reveal when AI learns deceptive strategies—as we demonstrated in <Anchor href="https://onlinelibrary.wiley.com/doi/10.1111/his.15180" target="_blank" className="research-link">histopathology</Anchor>, where models claiming superhuman cancer diagnosis actually relied on spurious correlations rather than meaningful biological features. See these tools in action: <Anchor href="https://serre-lab.github.io/Lens/" target="_blank" className="research-link">LENS explains what ImageNet models really see</Anchor>, and <Anchor href="https://serre-lab.github.io/LeafLens/" target="_blank" className="research-link">LeafLens reveals how AI identifies plant species from cleared leaves</Anchor>. We're now developing methods to identify the computational mechanisms learned by foundation models—work outlined in our <Anchor href="https://arxiv.org/abs/2509.17280" target="_blank" className="research-link">perspective on moving from prediction to understanding</Anchor> in brain science.
          </Text>
