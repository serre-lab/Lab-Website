    ...
    <>
      ...
      <div className="research-container">
        ...
        <div className="research-direction-card">
          ...
          <div className="funding-badge">Funded by ANR-3IA (ANR-19-PI3A-0004), the NSF AI Research Institute on Interaction for AI Assistants (ARIA; NSF Cooperative Agreement 2433429), and NIH/NIMH (R01 MH140004 and R01 MH143695)</div>
        </div>
