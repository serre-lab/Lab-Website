      ...
      <div className="research-container">
        ...
        <div className="research-direction-card">
          ...
          <Text className="research-direction-text">
            We are developing methods to quantify and improve the alignment between deep neural networks and human visual processing. Our <Anchor href="https://www.cell.com/trends/cognitive-sciences/fulltext/S1364-6613(25)00349-3" target="_blank" className="research-link">recent work</Anchor> reveals that despite impressive performance, current vision models process information fundamentally differently from humans—a gap crucial to understanding both for building more robust AI systems and for revealing brain mechanisms that support human vision. Our harmonization procedure demonstrates that alignment can be dramatically improved without changing network architectures, suggesting the misalignment stems not from structural limitations but from how these models are trained. This insight has led us to adopt a <Anchor href="https://openreview.net/forum?id=KeiQNpb7sv" target="_blank" className="research-link">developmental psychology approach</Anchor>, identifying the learning principles and developmental trajectories that shape human vision—principles we can incorporate into AI training to create models that not only perform well but genuinely see the world as humans do. Read more about this work in the <Anchor href="https://www.nsf.gov/news/training-ai-see-more-humans" target="_blank" className="research-link">NSF feature article</Anchor>.
          </Text>
          <div className="funding-badge">Funded by NSF (IIS-2402875) • <Anchor href="https://www.nsf.gov/news/training-ai-see-more-humans" target="_blank" style={{ color: 'white', textDecoration: 'underline' }}>Featured by NSF</Anchor></div>
        </div>
